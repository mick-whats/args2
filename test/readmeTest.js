...
(function() {
  ...
  describe("get", function() {
    it("case 1", function() {
      ...
      return assert.throws(sampleFunction, /String argument required/);
    });
  ...
  describe("bridge instance", function() {
    it("shift", function() {
      ...
      fn = function() {
        ...
        args = new args2(arguments);
        args.shift();
        return args.bridge(function(a, b) {
          equal(a, 'two');
          return equal(b, 'three');
        });
      };
  ...
  describe("shift and pop", function() {
    it("shift", function() {
      var fn;
      fn = function() {
        var args, text;
      ...
      return equal(fn('one', 'two', 'three'), 'one');
    });
    return it("pop", function() {
      var fn;
      fn = function() {
        var args, text;
        args = new args2(arguments);
      ...
      return equal(fn('one', 'two', 'three'), 'three');
    });
  });
